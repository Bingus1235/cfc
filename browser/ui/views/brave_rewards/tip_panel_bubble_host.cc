...
// drawn with rounded bottom borders. We implement these customization by
...
views::View* GetAnchorView(Browser* browser) {
  // TODO(zenparsing): Could also use browser_view->toolbar() which is a
  // ToolbarView and is the parent view of the location bar.
  DCHECK(browser);
...
void TipPanelBubbleHost::ShowPanelForPublisher(
    const std::string& publisher_id) {
  // No-op if the bubble is already open.
